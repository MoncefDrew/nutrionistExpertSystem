...
export function MealPlanForm({
  ...
  const generateMealPlan = async () => {
    try {
      ...
      // Get health data from the store
      const healthData = useHealthStore.getState();

      // Call our API endpoint
      const response = await axios.post("/api/client/mealsApi/generatePlan", {
        planType,
        mealsPerDay,
        healthData,
      });
      ...
      if (response.data.success) {
        ...
        // Update the form with generated meals
        reset({
          ...watch(),
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 font-medium text-white transition-colors rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50"
        >
